 ...
 */
export const ApiV1State$zodSchema = z.enum([
  "CLOSED",
  "INITIALIZED",
  "STARTED",
  "STOPPED",
...
export type ApiV1State = z.infer<typeof ApiV1State$zodSchema>;

/**
 * The deployment state of the API regarding the gateway(s).
 */
export const ApiV1DeploymentState$zodSchema = z.enum([
  "NEED_REDEPLOY",
  "DEPLOYED",
]).describe("The deployment state of the API regarding the gateway(s).");

export type ApiV1DeploymentState = z.infer<
  typeof ApiV1DeploymentState$zodSchema
>;
...
export type ApiV1 = {
  ...
  state?: ApiV1State | undefined;
  deploymentState?: ApiV1DeploymentState | undefined;
...
export const ApiV1$zodSchema: z.ZodType<ApiV1, z.ZodTypeDef, unknown> = z
  .object({
    ...
    deploymentState: ApiV1DeploymentState$zodSchema.optional(),
    ...
    state: ApiV1State$zodSchema.optional(),
