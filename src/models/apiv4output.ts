 ...
 * The state of the API regarding the gateway(s).
 */
export type ApiV4State = ClosedEnum<typeof ApiV4State>;
 ...
 */
export const ApiV4DeploymentState = {
 ...
 * The deployment state of the API regarding the gateway(s).
 */
export type ApiV4DeploymentState = ClosedEnum<typeof ApiV4DeploymentState>;
...
export const ApiV4Output$zodSchema: z.ZodType<ApiV4Output> = z.object({
  ...
  deploymentState: ApiV4DeploymentState$zodSchema.optional().describe(
    "The deployment state of the API regarding the gateway(s).",
  ),
  ...
  listeners: z.array(Listener$zodSchema).optional().describe(
  ...
  state: ApiV4State$zodSchema.optional().describe(
    "The state of the API regarding the gateway(s).",
  ),
  tags: z.array(z.string()).optional().describe(
    "The list of sharding tags associated with this API.",
  ),
  type: ApiType$zodSchema.optional().describe("API's type."),
...
export const ApiV4Input$zodSchema: z.ZodType<ApiV4Input> = z.object({
  _links: ApiLinks$zodSchema.optional(),
  allowMultiJwtOauth2Subscriptions: z.boolean().default(false).describe(
    "Allow an application to subscribe to more than one JWT/OAuth2 plan (V4 only).",
  ),
