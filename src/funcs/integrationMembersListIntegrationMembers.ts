...
import {
  ...
  ListIntegrationMembersRequest$zodSchema,
  ListIntegrationMembersResponse,
  ListIntegrationMembersResponse$zodSchema,
} from "../models/listintegrationmembersop.js";
...
export function integrationMembersListIntegrationMembers(
  ...
  request: ListIntegrationMembersRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListIntegrationMembersRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ListIntegrationMembersResponse$zodSchema, {
      key: "MembersResponse",
    }),
