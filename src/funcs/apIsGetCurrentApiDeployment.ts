...
import {
  ...
  GetCurrentApiDeploymentRequest$zodSchema,
  GetCurrentApiDeploymentResponse,
  GetCurrentApiDeploymentResponse$zodSchema,
} from "../models/getcurrentapideploymentop.js";
...
export function apIsGetCurrentApiDeployment(
  ...
  request: GetCurrentApiDeploymentRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetCurrentApiDeploymentRequest$zodSchema.parse(value$),
