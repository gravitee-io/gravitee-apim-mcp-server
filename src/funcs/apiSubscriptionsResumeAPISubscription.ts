...
import {
  ...
  ResumeApiSubscriptionRequest$zodSchema,
  ResumeApiSubscriptionResponse,
  ResumeApiSubscriptionResponse$zodSchema,
} from "../models/resumeapisubscriptionop.js";
...
export function apiSubscriptionsResumeAPISubscription(
  ...
  request: ResumeApiSubscriptionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ResumeApiSubscriptionRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ResumeApiSubscriptionResponse$zodSchema, {
      key: "Subscription",
    }),
