...
import {
  ...
  CreateIntegrationRequest$zodSchema,
  CreateIntegrationResponse,
  CreateIntegrationResponse$zodSchema,
} from "../models/createintegrationop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateIntegrationRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.CreateIntegration, {
    explode: true,
  });
