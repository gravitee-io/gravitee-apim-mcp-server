...
import {
  ...
  ReactivateApiSubscriptionApiKeyRequest$zodSchema,
  ReactivateApiSubscriptionApiKeyResponse,
  ReactivateApiSubscriptionApiKeyResponse$zodSchema,
} from "../models/reactivateapisubscriptionapikeyop.js";
...
export function apiSubscriptionsReactivateAPISubscriptionAPIKey(
  ...
  request: ReactivateApiSubscriptionApiKeyRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ReactivateApiSubscriptionApiKeyRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ReactivateApiSubscriptionApiKeyResponse$zodSchema, {
      key: "ApiKey",
    }),
