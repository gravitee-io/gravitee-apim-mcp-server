...
import {
  ...
  VerifyApiDeploymentRequest$zodSchema,
  VerifyApiDeploymentResponseResponse,
  VerifyApiDeploymentResponseResponse$zodSchema,
} from "../models/verifyapideploymentop.js";
...
export function apiSubscriptionsVerifyAPIDeployment(
  ...
  request: VerifyApiDeploymentRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VerifyApiDeploymentRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, VerifyApiDeploymentResponseResponse$zodSchema, {
