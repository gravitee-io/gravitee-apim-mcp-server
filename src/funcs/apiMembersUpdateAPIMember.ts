...
import {
  ...
  UpdateApiMemberRequest$zodSchema,
  UpdateApiMemberResponse,
  UpdateApiMemberResponse$zodSchema,
} from "../models/updateapimemberop.js";
...
export function apiMembersUpdateAPIMember(
  ...
  request: UpdateApiMemberRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateApiMemberRequest$zodSchema.parse(value$),
