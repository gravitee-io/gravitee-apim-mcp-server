...
import {
  ...
  TriggerApiScoringRequest$zodSchema,
  TriggerApiScoringResponse,
  TriggerApiScoringResponse$zodSchema,
} from "../models/triggerapiscoringop.js";
...
export function apiScoringTriggerAPIScoring(
  ...
  request: TriggerApiScoringRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TriggerApiScoringRequest$zodSchema.parse(value$),
