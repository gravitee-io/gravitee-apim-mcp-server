...
import {
  ...
  FetchDocumentationPageRequest$zodSchema,
  FetchDocumentationPageResponse,
  FetchDocumentationPageResponse$zodSchema,
} from "../models/fetchdocumentationpageop.js";
...
export function apiDocumentationFetchDocumentationPage(
  ...
  request: FetchDocumentationPageRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FetchDocumentationPageRequest$zodSchema.parse(value$),
