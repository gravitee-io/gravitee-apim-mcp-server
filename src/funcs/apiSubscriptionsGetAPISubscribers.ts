...
import {
  ...
  GetApiSubscribersRequest$zodSchema,
  GetApiSubscribersResponse,
  GetApiSubscribersResponse$zodSchema,
} from "../models/getapisubscribersop.js";
...
export function apiSubscriptionsGetAPISubscribers(
  ...
  request: GetApiSubscribersRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiSubscribersRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/subscribers")(
    pathParams$,
  );
