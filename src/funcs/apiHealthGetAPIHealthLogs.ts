...
import {
  ...
  GetApiHealthLogsRequest$zodSchema,
  GetApiHealthLogsResponse,
  GetApiHealthLogsResponse$zodSchema,
} from "../models/getapihealthlogsop.js";
...
export function apiHealthGetAPIHealthLogs(
  ...
  request: GetApiHealthLogsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiHealthLogsRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/health/logs")(
    pathParams$,
  );
