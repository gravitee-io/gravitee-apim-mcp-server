...
import {
  ...
  ExportApiSubscriptionsRequest$zodSchema,
  ExportApiSubscriptionsResponse,
  ExportApiSubscriptionsResponse$zodSchema,
} from "../models/exportapisubscriptionsop.js";
...
export function apiSubscriptionsExportAPISubscriptions(
  ...
  request: ExportApiSubscriptionsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ExportApiSubscriptionsRequest$zodSchema.parse(value$),
