...
import {
  ...
  VerifyCreateApiSubscriptionRequest$zodSchema,
  VerifyCreateApiSubscriptionResponse,
  VerifyCreateApiSubscriptionResponse$zodSchema,
} from "../models/verifycreateapisubscriptionop.js";
...
export function apiSubscriptionsVerifyCreateAPISubscription(
  ...
  request: VerifyCreateApiSubscriptionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VerifyCreateApiSubscriptionRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.VerifySubscription, {
    explode: true,
  });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, VerifyCreateApiSubscriptionResponse$zodSchema, {
