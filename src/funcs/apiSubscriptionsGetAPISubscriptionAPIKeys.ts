...
import {
  ...
  GetApiSubscriptionApiKeysRequest$zodSchema,
  GetApiSubscriptionApiKeysResponse,
  GetApiSubscriptionApiKeysResponse$zodSchema,
} from "../models/getapisubscriptionapikeysop.js";
...
export function apiSubscriptionsGetAPISubscriptionAPIKeys(
  ...
  request: GetApiSubscriptionApiKeysRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiSubscriptionApiKeysRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetApiSubscriptionApiKeysResponse$zodSchema, {
