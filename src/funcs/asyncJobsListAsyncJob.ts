...
import {
  ListAsyncJobRequest,
  ListAsyncJobRequest$zodSchema,
  ListAsyncJobResponse,
  ListAsyncJobResponse$zodSchema,
} from "../models/listasyncjobop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListAsyncJobRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/async-jobs")(
    pathParams$,
  );
