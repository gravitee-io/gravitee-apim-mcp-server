...
import {
  ...
  ListApiMembersRequest$zodSchema,
  ListApiMembersResponse,
  ListApiMembersResponse$zodSchema,
} from "../models/listapimembersop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListApiMembersRequest$zodSchema.parse(value$),
