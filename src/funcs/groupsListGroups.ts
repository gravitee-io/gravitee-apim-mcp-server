...
import {
  ListGroupsRequest,
  ListGroupsRequest$zodSchema,
  ListGroupsResponse,
  ListGroupsResponse$zodSchema,
} from "../models/listgroupsop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListGroupsRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/groups")(
    pathParams$,
  );
