...
import {
  ...
  GetApiSubscriptionRequest$zodSchema,
  GetApiSubscriptionResponse,
  GetApiSubscriptionResponse$zodSchema,
} from "../models/getapisubscriptionop.js";
...
export function apiSubscriptionsGetAPISubscription(
  ...
  request: GetApiSubscriptionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiSubscriptionRequest$zodSchema.parse(value$),
