...
import {
  VerifyPathsRequest,
  VerifyPathsRequest$zodSchema,
  VerifyPathsResponse,
  VerifyPathsResponse$zodSchema,
} from "../models/verifypathsop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VerifyPathsRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.VerifyApiPaths, { explode: true });
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/_verify/paths")(
    pathParams$,
  );
