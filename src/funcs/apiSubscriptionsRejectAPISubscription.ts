...
import {
  ...
  RejectApiSubscriptionRequest$zodSchema,
  RejectApiSubscriptionResponse,
  RejectApiSubscriptionResponse$zodSchema,
} from "../models/rejectapisubscriptionop.js";
...
export function apiSubscriptionsRejectAPISubscription(
  ...
  request: RejectApiSubscriptionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => RejectApiSubscriptionRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.RejectSubscription, {
    explode: true,
  });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, RejectApiSubscriptionResponse$zodSchema, {
      key: "Subscription",
    }),
