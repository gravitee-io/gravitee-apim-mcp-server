...
import {
  ...
  GetAverageMessagesPerRequestRequest$zodSchema,
  GetAverageMessagesPerRequestResponse,
  GetAverageMessagesPerRequestResponse$zodSchema,
} from "../models/getaveragemessagesperrequestop.js";
...
export function apiAnalyticsGetAverageMessagesPerRequest(
  ...
  request: GetAverageMessagesPerRequestRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetAverageMessagesPerRequestRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetAverageMessagesPerRequestResponse$zodSchema, {
