...
import {
  GetApiPagesRequest,
  GetApiPagesRequest$zodSchema,
  GetApiPagesResponse,
  GetApiPagesResponse$zodSchema,
} from "../models/getapipagesop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiPagesRequest$zodSchema.parse(value$),
