...
import {
  ...
  CloseApiSubscriptionRequest$zodSchema,
  CloseApiSubscriptionResponse,
  CloseApiSubscriptionResponse$zodSchema,
} from "../models/closeapisubscriptionop.js";
...
export function apiSubscriptionsCloseAPISubscription(
  ...
  request: CloseApiSubscriptionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CloseApiSubscriptionRequest$zodSchema.parse(value$),
