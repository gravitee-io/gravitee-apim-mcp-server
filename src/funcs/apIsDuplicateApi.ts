...
import {
  DuplicateApiRequest,
  DuplicateApiRequest$zodSchema,
  DuplicateApiResponse,
  DuplicateApiResponse$zodSchema,
} from "../models/duplicateapiop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DuplicateApiRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.DuplicateApiOptions, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/_duplicate")(
    pathParams$,
  );
