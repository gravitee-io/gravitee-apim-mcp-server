...
import {
  ...
  RevokeApiSubscriptionApiKeyRequest$zodSchema,
  RevokeApiSubscriptionApiKeyResponse,
  RevokeApiSubscriptionApiKeyResponse$zodSchema,
} from "../models/revokeapisubscriptionapikeyop.js";
...
export function apiSubscriptionsRevokeAPISubscriptionAPIKey(
  ...
  request: RevokeApiSubscriptionApiKeyRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => RevokeApiSubscriptionApiKeyRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, RevokeApiSubscriptionApiKeyResponse$zodSchema, {
      key: "ApiKey",
    }),
