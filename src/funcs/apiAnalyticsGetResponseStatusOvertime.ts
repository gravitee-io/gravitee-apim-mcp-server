...
import {
  ...
  GetResponseStatusOvertimeRequest$zodSchema,
  GetResponseStatusOvertimeResponse,
  GetResponseStatusOvertimeResponse$zodSchema,
} from "../models/getresponsestatusovertimeop.js";
...
export function apiAnalyticsGetResponseStatusOvertime(
  ...
  request: GetResponseStatusOvertimeRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetResponseStatusOvertimeRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetResponseStatusOvertimeResponse$zodSchema, {
