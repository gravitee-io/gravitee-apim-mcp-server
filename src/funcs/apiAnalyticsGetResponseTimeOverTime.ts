...
import {
  ...
  GetResponseTimeOverTimeRequest$zodSchema,
  GetResponseTimeOverTimeResponse,
  GetResponseTimeOverTimeResponse$zodSchema,
} from "../models/getresponsetimeovertimeop.js";
...
export function apiAnalyticsGetResponseTimeOverTime(
  ...
  request: GetResponseTimeOverTimeRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetResponseTimeOverTimeRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetResponseTimeOverTimeResponse$zodSchema, {
