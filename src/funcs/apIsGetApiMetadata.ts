...
import {
  ...
  GetApiMetadataRequest$zodSchema,
  GetApiMetadataResponse,
  GetApiMetadataResponse$zodSchema,
} from "../models/getapimetadataop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiMetadataRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/metadata")(
    pathParams$,
  );
