...
import {
  ...
  CreateApiWithImportDefinitionRequest$zodSchema,
  CreateApiWithImportDefinitionResponse,
  CreateApiWithImportDefinitionResponse$zodSchema,
} from "../models/createapiwithimportdefinitionop.js";
...
export function apIsCreateApiWithImportDefinition(
  ...
  request: CreateApiWithImportDefinitionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateApiWithImportDefinitionRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/_import/definition")(
    pathParams$,
  );
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, CreateApiWithImportDefinitionResponse$zodSchema, {
      key: "ApiV4",
    }),
