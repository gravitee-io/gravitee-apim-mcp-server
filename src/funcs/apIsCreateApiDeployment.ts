...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateApiDeploymentRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.ApiDeployment, { explode: true });
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/deployments")(
    pathParams$,
  );
