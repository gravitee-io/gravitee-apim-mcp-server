...
import {
  ...
  GetApiAnalyticsRequestCountRequest$zodSchema,
  GetApiAnalyticsRequestCountResponse,
  GetApiAnalyticsRequestCountResponse$zodSchema,
} from "../models/getapianalyticsrequestcountop.js";
...
export function apiAnalyticsGetAPIAnalyticsRequestCount(
  ...
  request: GetApiAnalyticsRequestCountRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiAnalyticsRequestCountRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetApiAnalyticsRequestCountResponse$zodSchema, {
