...
import {
  ...
  PauseApiSubscriptionRequest$zodSchema,
  PauseApiSubscriptionResponse,
  PauseApiSubscriptionResponse$zodSchema,
} from "../models/pauseapisubscriptionop.js";
...
export function apiSubscriptionsPauseAPISubscription(
  ...
  request: PauseApiSubscriptionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PauseApiSubscriptionRequest$zodSchema.parse(value$),
