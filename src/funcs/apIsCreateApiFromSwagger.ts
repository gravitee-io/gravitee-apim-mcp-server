...
import {
  ...
  CreateApiFromSwaggerRequest$zodSchema,
  CreateApiFromSwaggerResponse,
  CreateApiFromSwaggerResponse$zodSchema,
} from "../models/createapifromswaggerop.js";
...
export function apIsCreateApiFromSwagger(
  ...
  request: CreateApiFromSwaggerRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateApiFromSwaggerRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/_import/swagger")(
    pathParams$,
  );
