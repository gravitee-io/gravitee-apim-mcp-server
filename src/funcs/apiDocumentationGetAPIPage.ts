...
import {
  GetApiPageRequest,
  GetApiPageRequest$zodSchema,
  GetApiPageResponse,
  GetApiPageResponse$zodSchema,
} from "../models/getapipageop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiPageRequest$zodSchema.parse(value$),
