...
import {
  ...
  UpdateDocumentationPageRequest$zodSchema,
  UpdateDocumentationPageResponse,
  UpdateDocumentationPageResponse$zodSchema,
} from "../models/updatedocumentationpageop.js";
...
export function apiDocumentationUpdateDocumentationPage(
  ...
  request: UpdateDocumentationPageRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateDocumentationPageRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.UpdateDocumentation, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/pages/{pageId}")(
    pathParams$,
  );
