...
import {
  ...
  PublishApiPlanRequest$zodSchema,
  PublishApiPlanResponse,
  PublishApiPlanResponse$zodSchema,
} from "../models/publishapiplanop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PublishApiPlanRequest$zodSchema.parse(value$),
