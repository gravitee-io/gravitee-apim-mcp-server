...
import {
  ListApiPlansRequest,
  ListApiPlansRequest$zodSchema,
  ListApiPlansResponse,
  ListApiPlansResponse$zodSchema,
} from "../models/listapiplansop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListApiPlansRequest$zodSchema.parse(value$),
  ...
  const query$ = queryJoin(
    ...
    encodeFormQuery({
      ...
      "subscribableBy": payload$.subscribableBy,
    }),
  );
