...
import {
  ...
  ListApiAuditEventsRequest$zodSchema,
  ListApiAuditEventsResponse,
  ListApiAuditEventsResponse$zodSchema,
} from "../models/listapiauditeventsop.js";
...
export function apiAuditsListAPIAuditEvents(
  ...
  request: ListApiAuditEventsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListApiAuditEventsRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/audits/events")(
    pathParams$,
  );
