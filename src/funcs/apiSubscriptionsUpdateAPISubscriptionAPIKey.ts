...
import {
  ...
  UpdateApiSubscriptionApiKeyRequest$zodSchema,
  UpdateApiSubscriptionApiKeyResponse,
  UpdateApiSubscriptionApiKeyResponse$zodSchema,
} from "../models/updateapisubscriptionapikeyop.js";
...
export function apiSubscriptionsUpdateAPISubscriptionAPIKey(
  ...
  request: UpdateApiSubscriptionApiKeyRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateApiSubscriptionApiKeyRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.UpdateApiKey, { explode: true });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, UpdateApiSubscriptionApiKeyResponse$zodSchema, {
      key: "ApiKey",
    }),
