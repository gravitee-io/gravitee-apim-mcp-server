...
import {
  ...
  IngestIntegrationRequest$zodSchema,
  IngestIntegrationResponse,
  IngestIntegrationResponse$zodSchema,
} from "../models/ingestintegrationop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => IngestIntegrationRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.ApisIngest, { explode: true });
