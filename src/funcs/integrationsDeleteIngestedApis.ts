...
import {
  ...
  DeleteIngestedApisRequest$zodSchema,
  DeleteIngestedApisResponse,
  DeleteIngestedApisResponse$zodSchema,
} from "../models/deleteingestedapisop.js";
...
export function integrationsDeleteIngestedApis(
  ...
  request: DeleteIngestedApisRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteIngestedApisRequest$zodSchema.parse(value$),
