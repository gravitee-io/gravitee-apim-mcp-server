...
import {
  ...
  GetAverageConnectionDurationRequest$zodSchema,
  GetAverageConnectionDurationResponse,
  GetAverageConnectionDurationResponse$zodSchema,
} from "../models/getaverageconnectiondurationop.js";
...
export function apiAnalyticsGetAverageConnectionDuration(
  ...
  request: GetAverageConnectionDurationRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetAverageConnectionDurationRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetAverageConnectionDurationResponse$zodSchema, {
