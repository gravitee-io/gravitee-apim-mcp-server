...
import {
  ...
  CreateDocumentationPageRequest$zodSchema,
  CreateDocumentationPageResponse,
  CreateDocumentationPageResponse$zodSchema,
} from "../models/createdocumentationpageop.js";
...
export function apiDocumentationCreateDocumentationPage(
  ...
  request: CreateDocumentationPageRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateDocumentationPageRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.CreateDocumentation, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/pages")(
    pathParams$,
  );
