...
import {
  ...
  CreateApiPlanRequest$zodSchema,
  CreateApiPlanResponse,
  CreateApiPlanResponse$zodSchema,
} from "../models/createapiplanop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateApiPlanRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.CreatePlan, { explode: true });
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/plans")(
    pathParams$,
  );
