...
import {
  ...
  GetApiSubscriptionsRequest$zodSchema,
  GetApiSubscriptionsResponse,
  GetApiSubscriptionsResponse$zodSchema,
} from "../models/getapisubscriptionsop.js";
...
export function apiSubscriptionsGetAPISubscriptions(
  ...
  request: GetApiSubscriptionsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiSubscriptionsRequest$zodSchema.parse(value$),
