...
import {
  GetApiLogsRequest,
  GetApiLogsRequest$zodSchema,
  GetApiLogsResponse,
  GetApiLogsResponse$zodSchema,
} from "../models/getapilogsop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiLogsRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/logs")(
    pathParams$,
  );
