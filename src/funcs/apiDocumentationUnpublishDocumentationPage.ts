...
import {
  ...
  UnpublishDocumentationPageRequest$zodSchema,
  UnpublishDocumentationPageResponse,
  UnpublishDocumentationPageResponse$zodSchema,
} from "../models/unpublishdocumentationpageop.js";
...
export function apiDocumentationUnpublishDocumentationPage(
  ...
  request: UnpublishDocumentationPageRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UnpublishDocumentationPageRequest$zodSchema.parse(value$),
