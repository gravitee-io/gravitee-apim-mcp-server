...
import {
  ...
  GetApiScoringRequest$zodSchema,
  GetApiScoringResponse,
  GetApiScoringResponse$zodSchema,
} from "../models/getapiscoringop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiScoringRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/environments/{envId}/apis/{apiId}/scoring")(
    pathParams$,
  );
