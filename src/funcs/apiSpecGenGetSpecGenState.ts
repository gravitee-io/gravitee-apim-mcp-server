...
import {
  ...
  GetSpecGenStateRequest$zodSchema,
  GetSpecGenStateResponse,
  GetSpecGenStateResponse$zodSchema,
} from "../models/getspecgenstateop.js";
...
export function apiSpecGenGetSpecGenState(
  ...
  request: GetSpecGenStateRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetSpecGenStateRequest$zodSchema.parse(value$),
