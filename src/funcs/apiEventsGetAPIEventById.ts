...
import {
  ...
  GetApiEventByIdRequest$zodSchema,
  GetApiEventByIdResponse,
  GetApiEventByIdResponse$zodSchema,
} from "../models/getapieventbyidop.js";
...
export function apiEventsGetAPIEventById(
  ...
  request: GetApiEventByIdRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetApiEventByIdRequest$zodSchema.parse(value$),
