...
import {
  UpdateApiRequest,
  UpdateApiRequest$zodSchema,
  UpdateApiResponse,
  UpdateApiResponse$zodSchema,
} from "../models/updateapiop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateApiRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.UpdateApi, { explode: true });
